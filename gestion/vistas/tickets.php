<div class="p-4 border">
    <div class="row">
        ...
        <div class="col-4 text-center">
            <button id="btn-atender" class="btn btn-secondary btn-sm text-light">Atender al cliente</button>
            <button id="btn-actualizar" class="btn btn-secondary btn-sm text-light">Actualizar lista de tickets</button>
        </div>
    </div>
    <div class="row pt-4">
        <div class="col-8">
